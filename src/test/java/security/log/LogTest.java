...
class LogTest {
    ...
    // Fixed timestamp used across tests for predictable output
    ...
    @Test
    void testLogEntryWithCurrentTimestamp() {
    ...
    void testAuditLogSingletonReturnsSameInstance() {
        // The Singleton pattern must guarantee only one exists
    ...
    void testGetAllReturnsUnmodifiableList() {
        ...
        // The returned list must be unmodifiable to protect the internal state
